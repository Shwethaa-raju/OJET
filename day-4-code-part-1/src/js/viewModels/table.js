define(["knockout", "ojs/ojarraydataprovider", "ojs/ojtable", "ojs/ojpagingcontrol", "ojs/ojpagingdataproviderview"], 
    function(ko, ArrayDataProvider, table, paging, PagingDataProviderView){
